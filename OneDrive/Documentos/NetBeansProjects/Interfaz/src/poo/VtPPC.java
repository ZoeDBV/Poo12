 ...
 * @author zoebe
 */
public class VtPPC extends javax.swing.JFrame
{

    /**
     * Creates new form VtPPC
     */
    public VtPPC()
    {
        initComponents();
    ...
    private void initComponents()
    {
        ...
        setTitle("Consulta Productos Pereceberos");
    ...
    {//GEN-HEADEREND:event_formWindowOpened
        //desp.se(Manipulacion.consulta(VtPr.p));
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(VtPPC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
