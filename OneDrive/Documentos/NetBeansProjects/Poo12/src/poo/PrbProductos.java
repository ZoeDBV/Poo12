...
public class PrbProductos
{
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            Productos.setFolio((Integer)ManipulacionArchivos.carga(null,"folios.dat"));
        } catch (Exception e)
        {
            Productos.setFolio(0);
        }
        p=(Productos[]) ManipulacionArchivos.cargaArr(null,"Productos.dat");
        do
        {
        ...
        ManipulacionArchivos.guarda(null,p, "Productos.dat");
        ManipulacionArchivos.guarda(null,Productos.getFolio(), "folios.dat");
    }
